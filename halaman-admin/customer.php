...
<html>
	...
	<body>
      ...
      <div class="col-lg-10 offset-lg-2">
				 <br/>
				 <a href="tambah_customer.php" class="btn btn-success btn-md"><span class="fa fa-plus"></span> Tambah</a>
				 ...
				 <table class="table table-hover table-bordered" style="margin-top: 10px">
                    ...
                    <td><?php echo $a ?></td>
						...
						<td style="text-align: center;">
							<a href="edit_customer.php?id=<?php echo $isi['id_customer'];?>" class="btn btn-success btn-md">
							<span class="fa fa-edit"></span></a>
							<a onclick="return confirm('Apakah yakin data akan di hapus?')" href="hapus_customer.php?id=<?php echo $isi['id_customer'];?>" 
